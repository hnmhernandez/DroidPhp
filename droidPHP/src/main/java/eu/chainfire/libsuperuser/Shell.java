...
public class Shell {
    ...
    public static List<String> run(String shell, String[] commands, String[] environment,
        ...
        if (Debug.getSanityChecksEnabledEffective() && Debug.onMainThread()) {
            ...
            Debug.log(eu.chainfire.libsuperuser.ShellOnMainThreadException.EXCEPTION_COMMAND);
            throw new eu.chainfire.libsuperuser.ShellOnMainThreadException(eu.chainfire.libsuperuser.ShellOnMainThreadException.EXCEPTION_COMMAND);
        }
        ...
        try {
            ...
            eu.chainfire.libsuperuser.StreamGobbler STDOUT = new eu.chainfire.libsuperuser.StreamGobbler(shellUpper + "-", process.getInputStream(),
                    res);
            eu.chainfire.libsuperuser.StreamGobbler STDERR = new eu.chainfire.libsuperuser.StreamGobbler(shellUpper + "*", process.getErrorStream(),
                    wantSTDERR ? res : null);
    ...
    public static class Interactive {
        ...
        private eu.chainfire.libsuperuser.StreamGobbler STDOUT = null;
        private eu.chainfire.libsuperuser.StreamGobbler STDERR = null;
        ...
        protected void finalize() throws Throwable {
            if (!closed && Debug.getSanityChecksEnabledEffective()) {
                // waste of resources
                Debug.log(eu.chainfire.libsuperuser.ShellNotClosedException.EXCEPTION_NOT_CLOSED);
                throw new eu.chainfire.libsuperuser.ShellNotClosedException();
            }
            super.finalize();
        }
        ...
        private synchronized boolean open() {
            ...
            try {
                ...
                STDOUT = new eu.chainfire.libsuperuser.StreamGobbler(shell.toUpperCase(Locale.ENGLISH) + "-",
                ...
                STDERR = new eu.chainfire.libsuperuser.StreamGobbler(shell.toUpperCase(Locale.ENGLISH) + "*",
        ...
        public void close() {
            ...
            if (!_idle && Debug.getSanityChecksEnabledEffective() && Debug.onMainThread()) {
                Debug.log(eu.chainfire.libsuperuser.ShellOnMainThreadException.EXCEPTION_NOT_IDLE);
        ...
        public boolean waitForIdle() {
            if (Debug.getSanityChecksEnabledEffective() && Debug.onMainThread()) {
                Debug.log(eu.chainfire.libsuperuser.ShellOnMainThreadException.EXCEPTION_WAIT_IDLE);
                throw new eu.chainfire.libsuperuser.ShellOnMainThreadException(eu.chainfire.libsuperuser.ShellOnMainThreadException.EXCEPTION_WAIT_IDLE);
            }
